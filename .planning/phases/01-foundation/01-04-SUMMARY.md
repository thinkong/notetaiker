...
affects: ["all"]
tech-stack:
  added: ["husky", "@commitlint/cli", "@commitlint/config-conventional", "@changesets/cli"]
  patterns: ["Git hooks", "Conventional commits", "Automated versioning"]
key-files:
  created: [".husky/pre-commit", ".husky/commit-msg", "commitlint.config.js", ".changeset/config.json"]
