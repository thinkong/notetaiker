...
*Note on Truth #3: Highlighting is implemented primarily on hover (standard for force graphs) to allow rapid exploration, while single-click opens the `NoteSidePanel` for deeper context. This fulfills the "smooth exploration" goal effectively.*
